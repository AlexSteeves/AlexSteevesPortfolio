  ...
  return (
    <>
      <div className="absolute inset-y-0 left-0 ">
        <h1 className="text-3xl drop-shadow-xl mt-8 ml-12 text-normal font-serif text-grey-100 hover:text-gray-100 transition-all duration-500 hover:cursor-pointer">
          <a href="#about" > Alex Steeves</a>
      ...
      <div className="absolute inset-y-0 right-0">
        <Menu as="div" className="relative inline-block text-left">
          ...
          >
            <Menu.Items className="absolute right-0 z-10 mt-1 mr-5 w-56 origin-top-right divide-y divide-gray-500 rounded-md shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none bg-slate-200">
              <div className="py-1">
                <Menu.Item>
                  {({ active }) => (
                    <a
