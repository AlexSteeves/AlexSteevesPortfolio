...
export default function Navbar() {
  return (
    <header className="bg-gray-1000 md:sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a className="title-font font-medium text-gray-800 mb-4 md:mb-0 nav-text">
        ...
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-8 md:border-l md:border-gray-800	flex flex-wrap items-center text-base justify-center ">
          ...
          <a href="www.linkedin.com/in/alexander-steeves-8122b8178" className="mr-5 ">
